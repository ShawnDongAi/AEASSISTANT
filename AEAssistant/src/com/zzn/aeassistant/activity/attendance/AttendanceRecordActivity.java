...
public class AttendanceRecordActivity extends BaseActivity {
	...
	public void onClick(View v) {
		...
		case R.id.sum_by_user:
			...
			userIntent.putExtra(CodeConstants.KEY_START_DATE, startDateBtn
					.getText().toString());
			userIntent.putExtra(CodeConstants.KEY_END_DATE, endDateBtn
					.getText().toString());
		...
		case R.id.sum_by_project:
			...
			proIntent.putExtra(CodeConstants.KEY_START_DATE, startDateBtn
					.getText().toString());
			proIntent.putExtra(CodeConstants.KEY_END_DATE, endDateBtn.getText()
					.toString());
	...
	private boolean checkDate() {
		...
		try {
			startDate.setTime(dateFormat.parse(startDateBtn.getText()
					.toString()));
