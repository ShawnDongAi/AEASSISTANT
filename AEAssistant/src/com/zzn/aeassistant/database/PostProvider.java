...
public class PostProvider extends ContentProvider {
	...
	static {
		...
		postProjectionMap.put(PostDBHelper.CURRENT_PROJECT, PostDBHelper.CURRENT_PROJECT);
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		case PostDBHelper.ITEM_ID: {
			...
			sqlBuilder.setTables(PostDBHelper.table);
			sqlBuilder.setProjectionMap(postProjectionMap);
			sqlBuilder.appendWhere(PostDBHelper.CURRENT_PROJECT + "='" + project_id + "'");
			break;
		}
		case PostDBHelper.ITEM_NEW: {
			String project_id = uri.getPathSegments().get(1);
			...
			sqlBuilder.appendWhere(
					PostDBHelper.CURRENT_PROJECT + "='" + project_id + "' and " + PostDBHelper.IS_NEW + "='0'");
			break;
		}
		default:
			throw new IllegalArgumentException("Error Uri: " + uri);
