...
package com.zzn.aeassistant.zxing.camera;
...
public final class CameraManager {
	 ...
	 * 距离屏幕中间的位移
	 */
	private Rect framingOffsetRect;
	...
	public boolean isFlashlightOn() {
		...
		if (camera != null) {
			Parameters param = camera.getParameters();
			return Parameters.FLASH_MODE_TORCH.equals(param.getFlashMode());
		}
		return false;
	}
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			framingRect = new Rect(leftOffset + framingOffsetRect.left, topOffset + framingOffsetRect.top,
					leftOffset + width + framingOffsetRect.right, topOffset + height
							+ framingOffsetRect.bottom);
...
//			rect.bottom = rect.bottom * cameraResolution.x / screenResolution.y;
	...
	public Rect getFramingOffsetRect() {
		return framingOffsetRect;
	}

	public void setFramingOffsetRect(Rect framingOffsetRect) {
		this.framingOffsetRect = framingOffsetRect;
	}

	public void setFramingOffsetRect(int leftOffset, int topOffset, int rightOffset, int bottomOffset) {
		this.framingOffsetRect = new Rect(leftOffset, topOffset, rightOffset, bottomOffset);
		framingRect = null;
	}
}
