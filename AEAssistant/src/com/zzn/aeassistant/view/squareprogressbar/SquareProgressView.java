package com.zzn.aeassistant.view.squareprogressbar;
...
public class SquareProgressView extends View {
	...
	public SquareProgressView(Context context) {
		...
		progressBarPaint.setStrokeWidth(ToolsUtil.dip2px(getContext(),
				widthInDp));
	...
	protected void onDraw(Canvas canvas) {
		this.canvas = canvas;
		super.onDraw(canvas);
		strokewidth = ToolsUtil.dip2px(getContext(), widthInDp);
